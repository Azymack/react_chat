...
const DisplayChatCard = ({ item }) => {
  ...
  return (
    <div
      ...
      className="bg-primary-100 cursor-pointer rounded-lg shadow-md mt-3 hover:shadow-lg hover:ring-2 hover:ring-primary-200 hover:bg-primary-200 transition-shadow duration-200"
    >
